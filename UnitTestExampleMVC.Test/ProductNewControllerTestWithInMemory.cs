...
{
    public class ProductNewControllerTestWithInMemory : ProductNewControllerTest
    {
        public ProductNewControllerTestWithInMemory()
        {

            // Hangi database provider'ı kullanacğaımızı belirtiyoruz
            SetContextOptions(new DbContextOptionsBuilder<MVCUnitTestDBContext>()
                .UseInMemoryDatabase("MVCUnitTestDB").Options);
        }
